/**
 * =========================================================
 * Interface Eye Have Ear pour les lunettes Altitude EyeWear
 * ========================================================= 
 * 
 */
 ...
 */
// Selecteur lunette
#define pinSelector 23
int selectGlass = 0; 
String libelleLunette[] = {"Optivent ORA-2","AltitudeEyeWear AR1"};
 ...
 */
 void setup() {
  ...
  Serial.println("============================");
  Serial.print("     ");
  Serial.println(libelleLunette[selectGlass]);
  Serial.println("============================");
...
// if (Serial.available() > 0) {
 ...
 //================================================================
  if (dataDisplayed and (timerDisplay + displayDelay) < millis() ) {
      dataDisplayed = false;
      dataToSend = "        ";
